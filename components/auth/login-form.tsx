    ...
    <div className={cn('flex flex-col gap-6', className)} {...props}>
      <Card>
        <CardHeader className="text-center">
          ...
          <CardDescription>Escolha com o que logar</CardDescription>
        </CardHeader>
        <CardContent>
          <form>
            <FieldGroup>
              <Field>
                <AuthButton variant="login" provider="twitch">
                ...
                <AuthButton variant="login" provider="google">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-4 w-4 mr-2">
                    <path
                ...
                {/* <AuthButton variant="login" provider="kick">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 933.333 300" className="h-4 w-4 mr-2">
                    <path
